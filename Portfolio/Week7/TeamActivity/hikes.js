...
function showCommentsList()
  {
    ...
    document.querySelector("#viewTheComments").innerHTML = "";
    for (var i = 0; i < commentList.length; i++)
{
    document.querySelector("#viewTheComments").innerHTML += "<li>" +commentList[i].name+ ": " +commentList[i].content+ "</li>" ;
}
...
function renderOneHikeFull(hike) {
  ...
  item.innerHTML = ` 
    ...
    `;
 addComment(hike.name);
  return item;
 
}

function addComment(hike)
{
  let commentDiv = document.getElementById('commentsDiv');
  ...
  document.querySelector("#viewTheComments").innerHTML = "";
  console.log(hikeList[0].name);
  for (var i = 0; i < commentList.length; i++)
  {
 if(commentList[i].name == hike){
  document.querySelector("#viewTheComments").innerHTML += "<li>" +commentList[i].content+ "</li>" ;
