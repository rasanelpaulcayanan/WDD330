...
function startSearch(event)
{
  ...
  {
     baseUrl = 'https://www.thesportsdb.com/api/v1/json/1/search_all_leagues.php?c=Australia&s=Rugby';
    }
 else if (countrylist.value == 2)
 {
     baseUrl = 'https://www.thesportsdb.com/api/v1/json/1/search_all_leagues.php?c=England&s=Rugby';;
 }

 else
 {
     baseUrl = 'https://www.thesportsdb.com/api/v1/json/1/search_all_leagues.php?c=Worldwide&s=Rugby';
 }
 showLeague(baseUrl);
}
