...
function startSearch(event)
{
  ...
  {
     baseUrl = 'https://www.thesportsdb.com/api/v1/json/1/search_all_leagues.php?c=Canada&s=American_Football';
    }
 else if (countrylist.value == 2)
 {
     baseUrl = 'https://www.thesportsdb.com/api/v1/json/1/search_all_leagues.php?c=United_States&s=American_Football';;
 }
